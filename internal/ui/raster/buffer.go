// Package raster provides shared CPU RGBA drawing primitives used by
// internal/ui/app (chrome) and internal/ui/termview (grid): rect fills,
// rounded rects, glyph atlas, and src-over blending.
package raster
...
// blended against whatever is already there by alpha (0-255).
...
// BlendRect is FillRect's translucency-aware counterpart.
...
// BlitImageScaled composites src into buf at [x0,y0)-[x0+w,y0+h), nearest-neighbor scaled.
